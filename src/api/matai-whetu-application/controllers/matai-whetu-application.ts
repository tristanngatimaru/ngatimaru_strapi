...
export default factories.createCoreController('api::matai-whetu-application.matai-whetu-application', ({ strapi }) => ({
  async create(ctx) {
    ...
    try {
      ...
      console.error('❌ Failed to send Matai Whetu notification email:', error);
